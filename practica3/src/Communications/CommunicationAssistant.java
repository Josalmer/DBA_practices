...
/**
 *
 * @author Jose Saldaña, Miguel García Tenorio, Manuel Pancorbo, Domingo Lopez
 */
public class CommunicationAssistant {
     ...
     * @param print boolean para activar o desactivar impresión por consola
     */
    ...
    /**
     * Devuelve el nº de drones rescatando
     *
     * @author Jose Saldaña
     * @return nº de drones
     */
    ...
    /**
     * Pide e imprime por pantalla (solo si APB) las yellow pages
     *
     * @author Manuel Pancorbo
     * @return boolean que indica si ha habido éxito
     */
     ...
     * @param role Rol del agente que se subscribe
