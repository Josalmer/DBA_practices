    ...
    public Coordinates calculateDroneInitialPosition(Integer order) {
        ...
        switch (order) {
            ...
            case 2:
                ...
                initialPos = new Coordinates(this.adminData.map.size() / 2, this.adminData.map.get(0).size() / 2);
            ...
            case 4:
                ...
                initialPos = new Coordinates(this.adminData.map.size() / 2 + 30, this.adminData.map.get(0).size() / 2 + 30);
